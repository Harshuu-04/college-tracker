...
-- CreateEnum
CREATE TYPE "PlacementStatus" AS ENUM ('NOT_PLACED', 'PLACED', 'INTERN');
...
CREATE TABLE "Placement" (
    "id" TEXT NOT NULL,
    "studentId" TEXT NOT NULL,
    "status" "PlacementStatus" NOT NULL DEFAULT 'NOT_PLACED',
    "company" TEXT,
    "role" TEXT,
...
-- AddForeignKey
ALTER TABLE "Class" ADD CONSTRAINT "Class_proctorId_fkey" FOREIGN KEY ("proctorId") REFERENCES "Teacher"("id") ON DELETE SET NULL ON UPDATE CASCADE;
